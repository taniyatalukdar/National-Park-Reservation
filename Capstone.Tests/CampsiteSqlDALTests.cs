    ...
    public class CampsiteSqlDALTests
    {
        ...
        public void TestReservationUnderEmpty()
        {
            using (TransactionScope transaction = new TransactionScope())
            {
                ...
                int id = ReservationSqlDALTests.InsertFakeReservation(campSiteId, "Greg", "4/15/2018", "4/18/2018", Convert.ToString(DateTime.Now));
        ...
        [TestMethod]
        public void TestReservationUnderTwo()
        {
            using (TransactionScope transaction = new TransactionScope())
            {
                int parkId = ParkSqlDALTest.InsertFakePark(10, "test", (Convert.ToDateTime("1/15/1990")), "Cleveland", 1000, 42, "An amusing campsite");
                ...
                int campSiteId = CampsiteSqlDALTests.InsertFakeCampsite(campgroundId, 98, 6, true, 50, true);
                int id = ReservationSqlDALTests.InsertFakeReservation(campSiteId, "Greg", "4/15/2018", "4/18/2018", Convert.ToString(DateTime.Now));
                int id2 = ReservationSqlDALTests.InsertFakeReservation(campSiteId, "Jason", "10/10/2018", "10/18/2018", Convert.ToString(DateTime.Now));


                ReservationSqlDAL testClass = new ReservationSqlDAL(connection);

                List<Reservation> reservation = testClass.GetAllReservations("test");


                Assert.AreEqual(2, reservation.Count);
            }
        }

        [TestMethod]
        public void GetAvailableSameDatesResultsInFau()
        {
            using (TransactionScope transaction = new TransactionScope())
            {
                int parkId = ParkSqlDALTest.InsertFakePark(10, "test", (Convert.ToDateTime("1/15/1990")), "Cleveland", 1000, 42, "An amusing campsite");
                ...
                int campSiteId = CampsiteSqlDALTests.InsertFakeCampsite(campgroundId, 98, 6, true, 50, true);
                int id = ReservationSqlDALTests.InsertFakeReservation(campSiteId, "Greg", "4/15/2018", "4/18/2018", Convert.ToString(DateTime.Now));
                int id2 = ReservationSqlDALTests.InsertFakeReservation(campSiteId, "Jason", "4/15/2018", "4/18/2018", Convert.ToString(DateTime.Now));
        ...
        [TestMethod]
        public void TestReservationUnderSameFromDate()
        {
            using (TransactionScope transaction = new TransactionScope())
            {
                int parkId = ParkSqlDALTest.InsertFakePark(10, "test", (Convert.ToDateTime("1/15/1990")), "Cleveland", 1000, 42, "An amusing campsite");
                int campgroundId = CampgroundSqlDALTest.InsertFakeCampground(10, parkId, "test", 10, 5, 100);
                int campSiteId = CampsiteSqlDALTests.InsertFakeCampsite(campgroundId, 98, 6, true, 50, true);
                int id = ReservationSqlDALTests.InsertFakeReservation(campSiteId, "Greg", "4/1/2018", "4/16/2018", Convert.ToString(DateTime.Now));
                int id2 = ReservationSqlDALTests.InsertFakeReservation(campSiteId, "Jason", "4/1/2018", "4/18/2018", Convert.ToString(DateTime.Now));
        ...
        [TestMethod]
        public void TestReservationUnderSameToDate()
        {
            using (TransactionScope transaction = new TransactionScope())
            {
                int parkId = ParkSqlDALTest.InsertFakePark(10, "test", (Convert.ToDateTime("1/15/1990")), "Cleveland", 1000, 42, "An amusing campsite");
                int campgroundId = CampgroundSqlDALTest.InsertFakeCampground(10, parkId, "test", 10, 5, 100);
                int campSiteId = CampsiteSqlDALTests.InsertFakeCampsite(campgroundId, 98, 6, true, 50, true);
                int id = ReservationSqlDALTests.InsertFakeReservation(campSiteId, "Greg", "4/1/2018", "4/18/2018", Convert.ToString(DateTime.Now));
                int id2 = ReservationSqlDALTests.InsertFakeReservation(campSiteId, "Jason", "4/15/2018", "4/19/2018", Convert.ToString(DateTime.Now));
